 ...
 //$condition = "$title OR $content OR $picture";  //(title LIKE '%a%') ... OR (content LIKE '%b%) ...
  ...
  $condition = "$pro_name";
   ...
   //$pic = 123;
    ...
    $pro_detail = htmlspecialchars($data['detail']);

    $pro_price = htmlspecialchars($data['price']);


    $y_rand = rand(5 , $data['price']);
    $x_price = $data['price'] + $y_rand;

    $discount =  $x_price - $data['price'];
    ...
    echo "<br><br><a href=# class=\"pro-name\" data-id=\"$id\"><font color=\"green\">$pro_name</font></a>";
    echo "<br><br><a href=# class=\"pro_detail\" data-id=\"$id\">$pro_detail</a>";
    echo "<br><br><del>"."<span class=\"glyphicon glyphicon-usd\"></span> ".$x_price."</del>"." "."-".number_format($percount)."%"."<br>";
    echo "<a href=# class=\"pro_price\" data-id=\"$id\"><font color=\"red\">ราคา : $pro_price</font></a>";
