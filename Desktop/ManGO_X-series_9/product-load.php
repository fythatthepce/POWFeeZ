...
<div id="dialog-content">
 	<span id="dialog-pro-name" data-id="<?php echo $id; ?>">
    <?php
         echo $pro['pro_name'];
    ?></span>
...
?>
    <span id="dialog-price">
      <?php
      echo "<del>".$x_price."</del>"." "."-".number_format($percount)."%"."<br>";
      echo "ราคา : ".number_format($pro['price']);
      ?> บาท
