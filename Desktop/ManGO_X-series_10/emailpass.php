...
<div class="container">
  <br><br>
  <h5><c style="font-size:170%;">ส่งรหัสผ่านเข้าสู่อีเมลของท่านแล้ว...</c></h5>
  <br><br>
  <h5><a href="index2.php" class="btn btn-primary btn-md active" role="button">กลับสู่หน้าหลัก</a><h5>
