...
<body>
 ...
 <?php
    ...
    {
      $status++;
      echo "<font color=\"black\" size=\"1\">"."<span class=\"glyphicon glyphicon-user\"></span>"."</font>"." "."สวัสดีคุณ"." ".$_SESSION['user'];

      echo " "."<br>"."<a href=\"logout.php\">"."<font color=\"red\" size=\"1\"> log out</font>"."</a>";
    }else {

       echo "<font color=\"black\" size=\"10\">"."<span class=\"glyphicon glyphicon-log-in\"></span>"."</font>";

       echo "&nbsp;"."<a href=\"login.php\">"."<font color=\"black\" size=\"1\"> log in</font>"."</a>";
    }
 ?>
